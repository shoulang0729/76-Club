...
const ALPHA_GAMES=['fmt.net','fmt.gross','fmt.teamGross','fmt.teamNet','fmt.univMatch','fmt.best2','fmt.match1v1','fmt.customMatch','term.roulette','term.niapin','term.dracon'];
const BETA_GAMES =['fmt.stableford','fmt.olympic','fmt.callaway','fmt.nassau','fmt.vegas','fmt.hbh'];   // fmt.hbh は 2026-09-12 β 降格（Issue #160・BETA_FMT と対応）／fmt.best2 は 2026-09-19 α昇格（PR #199・BETA_FMT と対応）
